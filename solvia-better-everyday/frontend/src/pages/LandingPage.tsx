...
const features = [
  {
    icon: Smile,
    title: 'Mood Tracking',
    description: 'Monitor your emotional patterns with intuitive visual indicators and analytics.'
  },
  {
    icon: NotebookPen,
    title: 'Private Journaling',
    description: 'Express your thoughts in a secure, judgment-free space with guided prompts.'
  },
  {
    icon: BrainCircuit,
    title: 'AI-Powered CBT',
    description: 'Receive personalized therapy-style guidance through our intelligent assistant.'
  },
  {
    icon: Flower2,
    title: 'Mindfulness Activities',
    description: 'Practice breathing exercises, meditation, and grounding techniques for inner peace.'
  }
];
...
<header className="relative z-10">
  <nav className="flex items-center justify-between p-6 lg:px-8">
    <div className="flex items-center space-x-2">
      <img
        src="/assets/images/logo.png" // or "/logo.svg" or wherever your logo will live
        alt="Solvia Logo"
...
<section className="relative px-6 lg:px-20 py-20" style={{ backgroundColor: '#fcf3e6' }}>
  <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
    ...
    <div className="lg:w-1/2 text-center lg:text-left">
      ...
      <p className="text-xl lg:text-l text-gray-700 mb-8 animate-slide-up">
        ...
        and discover inner peace through guided mindfulness and CBT techniques.
      </p>
  ...
  <div className="max-w-6xl mx-auto px-6 lg:px-8">
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-700 max-w-2xl mx-auto">
        Tools crafted by mental health professionals to guide your personal journey.
      </p>
    </div>
...
<section className="bg-white py-20 px-6 lg:px-12">
  <div className="text-center mb-16">
    ...
    <p className="text-lg text-gray-600 max-w-2xl mx-auto mt-4">
      Follow these simple steps to begin your journey toward better mental wellness.
    </p>
  </div>
      ...
      {[1, 2, 3].map((step, index) => {
        ...
        return (
          ...
          >
            ...
            {/* Step Circle */}
            <div className={`w-10 h-10 rounded-full ${color} text-white font-bold flex items-center justify-center shadow-md mb-4 z-10 relative`}>
              {step}
            </div>
  ...
  <div className="max-w-5xl mx-auto px-6 lg:px-8">
    <div className="text-center mb-16">
      <h2 className="text-4xl font-bold mb-4 text-gray-900">Why Choose Solvia?</h2>
      <p className="text-xl text-gray-600">Join thousands on a journey of emotional well-being</p>
    </div>
